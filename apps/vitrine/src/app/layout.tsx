...
const offerCatalog = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      description: `Kit Bain + Kit Lit + ${CATALOG_DEFAULTS.KIT_COMPLET_SERVIETTES_INCLUSES} serviettes 50×90 incluses, remise groupage de ${CATALOG_DEFAULTS.KIT_COMPLET_DISCOUNT_CENTS / 100} €.`,
      price: centimes(CATALOG_DEFAULTS.KIT_COMPLET_CENTS),
      priceCurrency: "EUR",
    },
    {
      "@type": "Offer",
      name: `Pack Sérénité — abonnement mensuel (engagement ${SUBSCRIPTION_DEFAULTS.MIN_ENGAGEMENT_MONTHS} mois)`,
      description: `Formule mensuelle de location et entretien de linge, ${SUBSCRIPTION_DEFAULTS.KIT_BAIN_QTY} kits bain + ${SUBSCRIPTION_DEFAULTS.KIT_LIT_QTY} kits lit, livrés en ${SUBSCRIPTION_DEFAULTS.DELIVERIES_PER_MONTH} passages par mois (un par quinzaine, livraison et reprise incluses, linge repris sous ${SUBSCRIPTION_DEFAULTS.MAX_LINEN_KEEP_DAYS} jours maximum). Engagement minimum ${SUBSCRIPTION_DEFAULTS.MIN_ENGAGEMENT_MONTHS} mois, résiliable ensuite avec ${SUBSCRIPTION_DEFAULTS.NOTICE_PERIOD_DAYS} jours de préavis.`,
...
const localBusinessSchema = {
  ...
  description: `Linge Serein loue, livre et entretient le linge hôtelier (draps, serviettes, linge de bain et de lit) des hôtels, gîtes, chambres d'hôtes et locations saisonnières d'Orange et des communes limitrophes. Qualité hôtelière, démarche éco-responsable (Ecolabel, méthode RABC), engagement ${SUBSCRIPTION_DEFAULTS.MIN_ENGAGEMENT_MONTHS} mois, livraison standard sous J+2 à J+3 et options d'urgence (Express 24 h, jour même).`,
  ...
  areaServed: [
    ...
    { "@type": "City", name: "Piolenc" },
    { "@type": "City", name: "Caderousse" },
...
const organizationSchema = {
  ...
  areaServed: { "@type": "City", name: "Orange" },
  contactPoint: {
    "@type": "ContactPoint",
    telephone: "+33753569548",
...
const serviceSchema = {
  ...
  description: `Location, livraison et blanchisserie professionnelle de linge hôtelier (draps, serviettes, linge de bain et de lit) pour hôtels, gîtes, chambres d'hôtes et locations saisonnières d'Orange et des communes limitrophes. Démarche éco-responsable (Ecolabel, RABC), engagement ${SUBSCRIPTION_DEFAULTS.MIN_ENGAGEMENT_MONTHS} mois, livraison standard sous J+2 à J+3, urgence Express 24 h ou jour même.`,
